...
public class DepartmentServiceImplTest {
    ...
    public void highestPaidEmployeePositiveTest(Integer departmentId, Employee expected) {
    ...
    public void lowestPaidEmployeePositiveTest(Integer departmentId, Employee expected) {
    ...
    public void employeesForDepartmentPositiveTest(Integer department, List<Employee> expected) {
        assertThat(departmentService.printEmployeesForDepartment(department)).containsExactlyElementsOf(expected);
    }
